...
def parse_csv_to_json(csv_filepath):
    ...
    with open(csv_filepath, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        label_match = re.search(r'_(yes|no|deceptive)\.', csv_filepath)
...
def process_directory():
    ...
    deceptive_output_dir = os.path.join(output_base_dir, "deceptive")
    os.makedirs(truthful_output_dir, exist_ok=True)
    os.makedirs(deceptive_output_dir, exist_ok=True)

    # Collect files from truthful and deceptive folders
    truthful_dir = os.path.join(backup_base_dir, "truthful")
    deceptive_dir = os.path.join(backup_base_dir, "deceptive")
    ...
    print(f"Conversion complete! Processed {processed_truthful} truthful and {processed_deceptive} deceptive files.")
